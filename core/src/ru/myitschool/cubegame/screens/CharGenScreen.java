...
import ru.myitschool.cubegame.story.quest.StayHereQuest;
...
public class CharGenScreen extends AdvancedScreen {
    ...
    private void genChars(int count){
        ...
        if (count > 0){
            x += DungeonTile.TILE_WIDTH;
            Character mage = new Character(new Texture("sprites/Char1.png"), new Texture("mage.png"), x, y, 12, 12, 6, 6,4);
            Array<Skill> skills = new Array<Skill>();
