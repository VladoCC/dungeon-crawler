    ...
    public Room placeRoom(int x, int y, int side){
        ...
        if (left != null) {
            if (left.hasExit(Exit.DIRECTION_EAST)) {
                ...
                Point doorPoint = left.getExit(Exit.DIRECTION_EAST).getExitCells()[0];
                System.out.println("Door removed! Cords: (" + (doorPoint.x) + "; " + (doorPoint.y) + ")");
        ...
        if (right != null){
            if (right.hasExit(Exit.DIRECTION_WEST)){
                ...
                Point doorPoint = right.getExit(Exit.DIRECTION_WEST).getExitCells()[0];
                System.out.println("Door removed! Cords: (" + (doorPoint.x) + "; " + (doorPoint.y) + ")");
                Door.removeDoor(doorPoint.x, doorPoint.y);
            }
        } else {
        ...
        if (up != null){
            if (up.hasExit(Exit.DIRECTION_SOUTH)){
                ...
                Point doorPoint = up.getExit(Exit.DIRECTION_SOUTH).getExitCells()[0];
                System.out.println("Door removed! Cords: (" + (doorPoint.x) + "; " + (doorPoint.y) + ")");
                Door.removeDoor(doorPoint.x, doorPoint.y);
            }
        } else {
        ...
        if (down != null){
            if (down.hasExit(Exit.DIRECTION_NORTH)){
                ...
                Point doorPoint = down.getExit(Exit.DIRECTION_NORTH).getExitCells()[0];
                System.out.println("Door removed! Cords: (" + (doorPoint.x) + "; " + (doorPoint.y) + ")");
                Door.removeDoor(doorPoint.x, doorPoint.y);
            }
        } else {
