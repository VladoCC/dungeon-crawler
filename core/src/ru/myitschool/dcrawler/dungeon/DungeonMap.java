...
import ru.myitschool.dcrawler.ui.layers.PathTileLayer;
        ...
        input.addProcessor(new InputAdapter(){
            ...
            public boolean keyUp(int keycode) {
                if (keycode == Input.Keys.C){
                    ...
                    System.out.println("!!!!!!");
                    Entity entity = new GoblinWarrior(lastTileX * DungeonTile.TILE_WIDTH, lastTileY * DungeonTile.TILE_HEIGHT);
                    entity.add();
                    ((GoblinWarrior) entity).activateAI();
                    getCell(lastTileX, lastTileY).setEntity(entity);
